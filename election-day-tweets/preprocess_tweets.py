...
def get_averages_for_tests_images(df):
    ...
    return has[["popularity"]].to_dict(orient="index"), no[["popularity"]].to_dict(
        orient="index"), pd.DataFrame.from_dict(has_treatment, orient="index"), pd.DataFrame.from_dict(no_treatment,
                                                                                                       orient="index")